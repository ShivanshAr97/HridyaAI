...
const HeartFailurePrediction = () => {
  ...
  const selectReligion=["HINDU","NOT SPECIFIED","CATHOLIC","PROTESTANT QUAKER","BUDDHIST","JEWISH","EPISCOPALIAN","OTHER","GREEK ORTHODOX","UNOBTAINABLE","JEHOVAH'S WITNESS"]
  const selectEthnicity=["ASIAN","WHITE","ASIAN-CHINESE","BLACK/AFRICAN AMERICAN","HISPANIC OR LATINO","UNABLE TO OBTAIN","UNKNOWN/NOT SPECIFIED"]
  ...
  return (
    ...
    <div className='dark:bg-slate-800 min-h-screen flex items-center justify-center'>
      ...
      <div className='flex items-center justify-center'>
        <img src="/heart.png" alt="" className='w-full h-auto rounded shadow-md '/>
      </div>
      ...
      <label className='dark:text-gray-300 p-1'>Religion</label>
            ...
            <div className='flex flex-col'>
              <label className='dark:text-gray-300 p-1'>Emergency Time (hours)</label>
              <input
                type='number'
                value={emergencyTime}

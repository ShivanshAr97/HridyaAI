...
const Services = () => {
  return (
   <section className='bg-blue-50 py-16 dark:bg-slate-700'>
    <div className='text-center mb-10'>
    <h3 className='text-lg font-semibold text-gray-700'></h3>
    <p className='font-xl text-black font-semibold dark:text-gray-200'>Our Services</p>
    <h2 className="text-3xl font-bold text-gray-600 dark:text-gray-400">3 Easy Steps To Care Your Heart</h2>
    </div>
    <div className='flex flex-col items-center justify-center md:flex-row space-y-6 md:space-y-0 md:space-x-8'>
        <div className='flex flex-col items-center bg-white p-14 rounded-lg shadow-md dark:bg-slate-400'>
           <img src='/healthcare1.png' alt="" />
            <h3 className="text-2xl font-semibold mb-2 dark:text-gray-100">Step 1</h3>
        ...
        <div className="flex flex-col items-center bg-white p-14 rounded-lg shadow-md dark:bg-slate-400">
          ...
          <h3 className="text-2xl font-semibold mb-2 dark:text-gray-100">Step 2</h3>
        ...
        <div className='flex flex-col items-center bg-white p-14 rounded-lg shadow-md dark:bg-slate-400'>
            ...
            <h3 className='text-2xl font-semibold mb-2 dark:text-gray-100'>Step 3</h3>
